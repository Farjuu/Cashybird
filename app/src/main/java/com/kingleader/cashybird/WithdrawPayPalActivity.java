...
public class WithdrawPayPalActivity extends Activity implements MaxAdViewAdListener, MaxAdListener
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.withdraw_paypal);
        ...
        dialog = new ProgressDialog(WithdrawPayPalActivity.this);
...
//                admobInterstital();
    ...
    {
        WithdrawPayPalActivity.totalEarnedCoins = totalCoins;
    }
    ...
    public void checkIsWithdrawEligible(View view)
    {
        ...
        if(totalCoins>=ELIGIBLE_LIMIT)
        {
            ...
            Intent intent = new Intent(this, WithdrawPaypalInitActivity.class);
    ...
    protected void onDestroy()
    {
        ...
        WithdrawPayPalActivity.this.finish();
        super.onDestroy();
    }
