...
public class WithdrawPaypalInitActivity extends Activity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_withdraw_paypal_init);
        ...
        dialog = new ProgressDialog(WithdrawPaypalInitActivity.this);
    ...
    private void showErrorWhileProcessing() // Withdraw Failed
    {
        ...
        okayButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                noInternetDialog.dismiss();
                Intent intent= new Intent(WithdrawPaypalInitActivity.this, MainActivity.class);
                startActivity(intent);
                WithdrawPaypalInitActivity.this.finish();
            }
        });
        noInternetDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        noInternetDialog.setCancelable(false);
